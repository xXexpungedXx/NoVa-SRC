...
public class YggdrasilPayload {
    public static Session loginPassword(String username, String password) {
        ...
        try {
            b.logIn();
            return new Session(b.getSelectedProfile().getName(), b.getSelectedProfile().getId().toString(), b.getAuthenticatedToken(),namecheck(username));
    ...
    public static Session loginCrack(String username) {
        return new Session(username, "-", "-",namecheck(username));
    }
